...
<p><br/></p>
	<div class="container">
		<form name="myform" method="post" enctype="multipart/form-data">
			...
			<br/>
			<div>
				<!-- <input type="button" value="파일박스추가" onclick="fileBoxAppend()" class="btn btn-secondary btn-sm mb-2" /> -->
			...
			<div class="mb-2">
				내용 : <textarea rows="4" name="content" id="content" placeholder="자료의 상세정보를 입력하세요" class="form-control"></textarea>
			</div>
			<div class="mb-2">
				분류 : 
			...
			<div>
				<input type="button" value="자료올리기" onclick="fCheck()" class="btn btn-dark" />
				<input type="reset" value="다시쓰기" class="btn btn-dark" />
				<input type="button" value="돌아가기" onclick="location.href='pdsList?part=${part}';" class="btn btn-dark" />
			</div>
