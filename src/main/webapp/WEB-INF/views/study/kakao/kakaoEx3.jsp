...
<p><br/></p>
<div class="container">
  <h2>지점명으로 위치 검색 후 카카오DB에 저장된 '위도/경도'를 알아내어 나의 DB에 저장하기(${address})</h2>
  <hr/>
  ...
  <div>
  	<form name="myform">
  		<p>키워드 검색 : 
  			...
  			<input type="submit" value="키워드검색" class="btn btn-light" />
  			<input type="button" value="나의DB에저장" onclick="addressSave()" class="btn btn-light" /><br/>
  			<span id="demo"></span>
  		</p>
