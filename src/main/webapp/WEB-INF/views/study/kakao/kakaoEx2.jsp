...
<head>
  ...
  <script>
    ...
    function addressDelete() {
			...
			let ans = confirm("검색한 지점명을 DB에서 삭제하시겠습니까?");
			if(!ans) return false;
...
<div class="container">
  ...
  <div>
  	<form name="myform">
  		...
  		<input type="button" value="지점검색" onclick="addressSearch()" class="btn btn-light" />
  		<input type="button" value="검색된지점삭제" onclick="addressDelete()" class="btn btn-light" />
  	</form>
  </div>
  <hr/>
