...
<div class="container">
  ...
  <form name="myform" method="post" enctype="multipart/form-data">
  	...
  	<p>
  		...
  		<input type="button" value="멀티파일업로드이동" onclick="location.href='multiFile';" class="btn btn-warning" />
  	</p>
 	</form>
 	<hr/>
 	<div id="downloadFile">
 		...
 		<div class="row">
 			<div class="col-6 mb-2">저장 경로 : ${ctp}/resources/data/study/*.*</div>
 			<div class="col-4 mb-2"></div>
 			<div class="col-2 mb-2">
 				<input type="button" value="폴더 내 모든파일 삭제" onclick="fileDeleteAll()" class="btn btn-sm btn-warning" />
 			</div>
 		</div>
