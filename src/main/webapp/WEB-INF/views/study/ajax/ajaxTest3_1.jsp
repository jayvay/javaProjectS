...
<head>
  ...
  <script>
	  ...
	  function fCheck() {
			...
			str += '<input type="button" value="다시선택" onclick="location.reload()" class="btn btn-light"/>';
			$("#demo").html(str);
		}
  </script>
</head>
...
<p><br/></p>
<div class="container">
  <h2>AJax 문자열 배열 (ajaxTest3_1.jsp)</h2>
  <hr/>
  <form>
  	<h4>도시를 선택하세요</h4>
  	...
  	<select name="city" id="city">
		...
		<input type="button" value="선택" onclick="fCheck()" class="btn btn-light mr-3" />
		<input type="button" value="돌아가기" onclick="location.href='ajaxForm';" class="btn btn-light mr-3" />
  </form>
