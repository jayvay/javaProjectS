...
<head>
  ...
  <script>
    ...
    // 소분류 삭제하기
    function categorySubDelete(categorySubCode, categoryMiddleCode, categoryMainCode) {
    ...
    <table class="table table-hover m-3">
      ...
      <c:forEach var="subVO" items="${subVOS}">
        <tr class="text-center">
          ...
          <td><input type="button" value="삭제" onclick="categorySubDelete('${subVO.categorySubCode}','${subVO.categoryMiddleName}','${subVO.categoryMainName}')" class="btn btn-danger btn-sm"/></td>
        </tr>
      </c:forEach>
