...
<div class="container">
  ...
  <table class="table table-borderless">
    <tr>
      ...
      <td class="text-right"><a href="guestInput" class="btn btn-light">글쓰기</a></td>
    </tr>
  </table>
  ...
  <div class="text-center">
  	<ul class="pagination justify-content-center">
	  	...
	  	<c:forEach var="i" begin="${(curBlock*blockSize)+1}" end="${(curBlock*blockSize)+blockSize}" varStatus="st">
  	  	<c:if test="${i <= totPage && i == pag}"><li class="page-item active"><a class="page-link bg-secondary" href="guestList?pag=${i}&pageSize=${pageSize}">${i}</a></li></c:if>
